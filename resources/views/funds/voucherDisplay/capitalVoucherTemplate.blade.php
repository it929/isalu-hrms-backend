...
<div class="mainVoucher">
    ...
    <div class="row">
        <div class="col-md-8 fla1">
            <div align="left" style="font-weight: 100">
                Departmental No. <b>SCN/OC/CAP/<input type="text" class="noborder"
    ...
    <div class="row checkPass2"
        style="border-bottom: 1px solid black; border-top: 1px solid black; padding: 5px 0px;">
        ...
        <div class="col-md-6 fr1">
            Total: <strong> &#8358;{{ number_format($list->amtPayable, 2, '.', ',') }} </strong>
        </div>
    </div>

    <div class="row">
        <div class="col-md-12 checkPass2">
            <h6>I certify the above amount is correct, and was incurred under the Authority quoted,
...
@if ($list->WHTValue > 0)
    <div class="withHoldTaxVoucher">
        ...
        <div class="row">
            <div class="col-md-8 fla1">
                @if (isset($voucherOffsets['wht']))
                <div align="left" style="font-weight: 100">
                    Departmental No. <b>SCN/OC/CAP/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['wht']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
                <table class="table table-borderedd text-center table-condensed" style="font-size: 10px">
                    <tbody>
                                ...
                                <table class="input-sm" style="width:100%;">
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>&#8358;{{ number_format($list->WHTValue, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>
        ...
        <div class="row checkPass2"
            ...
            <div class="col-md-6 fr1">
                <strong>Total: &#8358;{{ number_format($list->WHTValue, 2, '.', ',') }} </strong>
            </div>
        </div>
...
@if ($list->VATValue > 0)
    <div class="vatVoucher">
        ...
        <div class="row">
            <div class="col-md-8 fla1">
                @if (isset($voucherOffsets['vat']))
                <div align="left" style="font-weight: 100">
                    Departmental No. <b>SCN/OC/CAP/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['vat']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
                <table class="table table-borderedd text-center table-condensed" style="font-size: 10px">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="650">
                                <div align="left">
                                    ...
                                    Paid
                                    &#8358;{{ number_format($list->totalPayment, 2, '.', ',') }} less
                                ...
                                <table class="input-sm" style="width:100%;">
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>&#8358;{{ number_format($list->VATValue, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>
        ...
        <div class="row checkPass2"
            ...
            <div class="col-md-6 fr1">
                <strong>Total: &#8358;{{ number_format($list->VATValue, 2, '.', ',') }} </strong>
            </div>
        </div>
...
@if ($list->stampduty > 0)
    <div class="stampDutyVoucher">
        ...
        <div class="row">
            <div class="col-md-8 fla1">
                @if (isset($voucherOffsets['stamp']))
                <div align="left" style="font-weight: 100">
                    Departmental No. <b>SCN/OC/CAP/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['stamp']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
                <table class="table table-borderedd text-center table-condensed" style="font-size: 10px">
                    <tbody>
                                ...
                                <table class="input-sm" style="width:100%;">
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>&#8358;{{ number_format($list->stampduty, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>
        ...
        <div class="row checkPass2"
            ...
            <div class="col-md-6 fr1">
                <strong>Total: &#8358;{{ number_format($list->stampduty, 2, '.', ',') }} </strong>
            </div>
        </div>
...
@if ($list->WHTValue > 0)
    @for ($i = 1; $i <= 2; $i++)
        <div class="journalWTHVoucher" style="margin-top: 40px;">
                    ...
                    <table class="table table-condensed table-borderedd text-center input-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $list->ecoHeadCode }}{{ $list->economicCode }}</td>
                                <td><strong>{{ number_format($list->WHTValue, 2, '.', ',') }}<strong></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
            ...
            <div class="row">
                <div class="col-md-12 padNarrationPrepared2">
                    ...
                    <table class="table table-condensed table-borderedd text-center input-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $list->ecoHeadCode }}{{ $list->economicCode }}</td>
                                <td><strong>{{ number_format($list->VATValue, 2, '.', ',') }}</strong></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                    ...
                    <table class="table table-condensed table-borderedd text-center input-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>STAMP DUTY</td>
                                <td>{{ $list->ecoHeadCode }}{{ $list->economicCode }}</td>
                                <td><strong>{{ number_format($list->stampduty, 2, '.', ',') }}</strong></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
