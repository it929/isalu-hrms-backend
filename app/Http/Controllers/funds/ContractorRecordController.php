...
class ContractorRecordController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('funds.contractorRecord.contractorRecord', $data);
    }
    ...
    public function view($ContID)
    {
        ...
        return view('funds.contractorRecord.view', $data);
    }
    ...
    public function QueryTable($getcompanyId, $getstatusId, $getTime1, $getTime2)
    {
        $qcompany = 1;
        if ($getcompanyId != '') {
            $qcompany = "`companyID`='$getcompanyId'";
        }

        $qstatus = 1;
        if ($getstatusId != '') {
            $qstatus = "`approvalStatus`='$getstatusId'";
        }
