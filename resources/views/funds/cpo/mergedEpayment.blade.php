    ...
    <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div align="right" class="col-xs-6">
                        <table>
                            <tr>
                                <td>
                                    <div align="left">Reference No: <input type="text" class="type"
                                            name="batch" bch="{{ $current_batch }}"
                                            value="{{ $status->adjusted_batch ?? '' }}" id="batchRef" /><br />
                                        Code:
        ...
        <div style="öpacity:0.2">
            <div style="width:65%; margin:auto">
                Please credit the account(s) of the below listed beneficiary(s) and debit our account below with UPDATE:
                            ...
                            @foreach ($mandate as $reports)
                                ...
                                if ($reports->transactionID != $transId) {
                                    echo '
                                        ...
                                        '" class="btn btn-success btn-xs hidden-print no-print" target="_blank">View Voucher</a></td>
                                                                                                                                                                                    <td class="hidden-print"><a href="javascript:void()" class="update btn btn-success btn-xs hidden-print no-print" contr="' .
                                        $reports->contractor .
                                        '" btc="' .
                                        $current_batch .
                                        '" id="' .
                                        $reports->ID .
                                        '">Update</a></td>
                                                                                                                                                                                    <td class="hidden-print"><a href="javascript:void()" class="edit btn btn-success btn-xs hidden-print no-print" pps="' .
                                        $reports->purpose .
                                        '" id="' .
                                        $reports->ID .
                                        '">Edit</a></td>
                                ...
                                if ($reports->WHTValue == 0 && $reports->VATValue == 0) {
                                    ...
                                    echo '
                                        ...
                                        ' </td>
                                                                                                                                                                                            <td class="tblborder"></td>
                                                                                                                                                                                            <td class="tblborder"> FIRS Remittance (TAX) </td>
                                                                                                                                                                                            <td class="hidden-print"><a href="' .
                                        $url .
                                        '" class="btn btn-success btn-xs hidden-print no-print" target="_blank">View Voucher</a></td>
                                
                                                                                                                                                                                            <td class="hidden-print"><a href="javascript:void()" tx="tax" accts="' .
                                        $reports->wht_accountNo .
                                        '" bk="' .
                                        $reports->wht_bank .
                                        '" bene="' .
                                        $reports->wht_payee .
                                        '" class="tax btn btn-success btn-xs hidden-print no-print" btc="' .
                                        $current_batch .
                                        '" id="' .
                                        $reports->ID .
                                        '">Update</a></td>
                                        ...
                                        ' </td>
                                                                                                                                                                                            <td class="tblborder"></td>
                                                                                                                                                                                            <td class="tblborder"> FIRS Remittance (VAT) </td>
                                                                                                                                                                                            <td class="hidden-print"><a href="' .
                                        $url .
                                        '" class="btn btn-success btn-xs hidden-print no-print" target="_blank">View Voucher</a></td>
                                                                                                                                                                                            <td class="hidden-print"><a href="javascript:void()" vt="vat" accts="' .
                                        $reports->vat_accountNo .
                                        '" bk="' .
                                        $reports->vat_bank .
                                        '" bene="' .
                                        $reports->vat_payee .
                                        '" class="vat btn btn-success btn-xs hidden-print no-print" btc="' .
                                        $current_batch .
                                        '" id="' .
                                        $reports->ID .
                                        '">Update</a></td>
            ...
            <form method="post" action="{{ url('/cpo/update-account-merged') }}">
                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="accountNo" id="accountNo" class="form-control"
                                            required>
                                        <input type="hidden" name="actbatch" id="batch" class="actbatch">
                                        <input type="hidden" name="contractor" id="contractor" class="contractor">
            ...
            <form method="post" action="{{ url('/cpo/update-narration-merged') }}">
                {{ csrf_field() }}
            ...
            <form method="post" action="{{ url('/update-payee-account-merged') }}">
                {{ csrf_field() }}
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $("table tr td .update").click(function() {
                        ...
                        var cont = $(this).attr('contr');
                        //var bank    = $(this).attr('bk');
                        //var account = $(this).attr('accts');
                        $(".actbatch").val(batchNo);
                        $(".epaymentID").val(epayID);
                        $(".contractor").val(cont);
                        $(".actModal").modal('show');
                        // $("#banks").append('<option value="">'+ +'</option>')
                    });
                });
            </script>
