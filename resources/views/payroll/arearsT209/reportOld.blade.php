...
<div align="center"></div>            <div align="center"></div></td>
          <td width="342"><div align="center"><strong>AMOUNT</strong>(&#8358;)</div></td>
            ...
            @php $serial = 1; @endphp
            @foreach($details as $getdetails)
           @if($getdetails->$getvalue >0)
            <tr>
          <td align="center">{{$serial++}}</td>
          <td align="left">{{$getdetails->name}}</td>
          <td align="right">{{ number_format($getdetails->$getvalue, 2, '.', ',')}}</td>
          </tr>
         @endif
            @endforeach 
