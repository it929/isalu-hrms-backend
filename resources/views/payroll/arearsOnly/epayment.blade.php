      ...
      <div class="row">
        <div align="left" class="col-xs-6">
          <table > 
            ...
            <tr><td align="left">First Bank of Nigeria,</td></tr>
        ...
        <div align="right" class="col-xs-6">
          <table > 
            ...
            Division:  @if(session('bank'))
            {{session('division')}} {{session('bank') }} 
            @endif
            <br />
          </div></td></tr>
          </table>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td colspan="2">
            <table class="table table-responsive table-bordered">
                  ...
                  <tr class="tblborder">
                    ...
                    <td class="tblborder" align="right">   {{ number_format( $reports->netpay + $reports->callDuty, 2, '.', ',')}} </td>
                    <td class="tblborder"> {{session('sortCode')}}</td>
                    <td class="tblborder">  {{session('month')}}  {{session('year') }} Staff Arrears  </td>
                  </tr>  
                  <?php 
                  $sum = $sum + ($reports->netpay + $reports->callDuty);
                  $counter=$counter+1;
                  ?>
                  @endforeach
                  <tr class="tblborder">
        ...
        <tr><td colspan="2">
          <div class="no-print" align="center">
                    ...
                    <?php 
                    $finalsum = $finalsum + ($reports->netpay + $reports->callDuty);
                    ?>
                    @endforeach
        </td></tr>
        <tr>
          <td colspan="2">
            <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="no-border" align="left">Name:  {{$name1}}</td>
                          <td class="no-border" rowspan="2"><img src="{{asset('Images/sch.jpg')}}"   /></td>
                          <td class="no-border" align="left">Name: {{$name3}}</td>
                        ...
                        <tr>
                          <td class="no-border" align="left" valign="top">Signature: <br />
                            ...
                            <tr>
                              <td class="no-border" align="left">Tel No: <span class="sign1">{{$phone1}}</span></td>
                              <td class="no-border">&nbsp;</td>
                              <td class="no-border" colspan="2" align="left">Tel No: <span class="sign2">{{$phone3}}</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>          
                              <td class="no-border" align="left">Name: {{$name2}}
                          </td>
                              <td class="no-border" rowspan="2"><img src="{{asset('Images/sch.jpg')}}"   /></td>
                            ...
                            <tr>
                              <td class="no-border" valign="top" align="left">Signature:<br />
                                ...
                                <tr>
                                  <td class="no-border" align="left">Tel No: <span class="sign3">{{$phone2}}</span>
                                  </td>
                                  <td class="no-border">&nbsp;</td>
