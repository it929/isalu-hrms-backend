...
class EmolumentController extends ParentController
{
    ...
    public function justices_emolument()
    {
        $data['User'] = auth()->user();
        $data['getStaff'] = DB::table('tblper')
            ->where('staff_status', 1)
        ...
        return view('Emolument.justice-emolument', $data);
    }
    ...
    public function update_justice_emolument(Request $request)
    {
        // dd($request->all());
        ...
        $message = 'Personal Emolument records updated successfully';
        $err = 'Personal Emolument records for Judge could not be updated';
        if ($checkupdate) {
            return back()->with(
                'msg',
                $message
    ...
    public function update_emolument(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'fileNo' => [
                'required',
                Rule::unique('tblper', 'fileNo')->ignore($request->findID, 'ID'),
            ],
        ]);
        ...
        if ($image == '') {
            ...
            $photoPath = $request->hasFile('photo')
                ? env('APP_URL') . "/storage/" . $request->file('photo')->store('passport', 'public')
                : null;
    ...
    public function newStaff()
    {
        ...
        return view('payroll.Emolument.newStaff', $data);
    }
    ...
    public function addNewstaff(Request $request)
    {
        $this->validate($request, [
            ...
            'account_no' => 'required',
            'bankGroup' => 'nullable',
            'fileNo' => 'required|unique:tblper,fileNo'
        ]);
        // dd($request->all());
    ...
    public function accountUpdate()
    {
        ...
        return view('payroll.Emolument.updateAccountDetail', $data);
    }
