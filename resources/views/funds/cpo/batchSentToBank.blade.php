        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <!-- Titles -->
                    <h3 class="text-center" style="margin-top: 10px;">MANDATE SENT TO BANK LIST</h3>
                    <br>
                                    ...
                                    @forelse ($audited as $list)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ number_format($list->sum, 2) }}</td>

                                            <!-- View Batch -->
                                            <td class="hidden-print">
                                                <a href="{{ url('/cpo/payments/sent-to-bank/' . $list->batch) }}"
                                                    class="btn btn-success btn-xs">
                                                    View Components
                                                </a>
                                                <a href="{{ url('/view/batch/regenerated/' . $list->batch) }}"
                                                    class="btn btn-success btn-xs">
                                                    View Mandate
                                                </a>
