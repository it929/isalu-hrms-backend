                ...
                <div class="col-md-12">
                    ...
                    <table border="1" class="table table-bordered table-hover">
                        <tr>
                            ...
                            <th class="text-center">PECULIAR/ALLOWANCE</th>
                            {{-- <th class="text-center">40% PECULIAR FG</th> --}}
                        ...
                        @foreach ($report as $reports)
                            <tr>
                                ...
                                {{-- <td align="right">{{ number_format($reports->peculiarFG, 2, '.', ',') }}</td> --}}
                    ...
                    <div class="no-print">
                        <a href = "{{ url('/salaryScale') }}"> <strong> HOME </strong></a>
                        <Bold> Select a grade:</Bold></br>
                        {{ $results->links() }}
                    </div>
                </div>
            </div>
