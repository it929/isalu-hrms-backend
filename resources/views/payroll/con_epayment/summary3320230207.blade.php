...
<div>
 ...
 @foreach($epayment_detail as $list)
  ...
  <?php 
  if(session('month') == 'OCTOBER' && session('year') == 2019)
  {
      $nhisVal = 0;
  }
  else
            ...
            <table class="table table-responsive table-bordered" id="tableData">
                 ...
                 <?php 
                  ...
                  <tr>
                    ...
                    <td class="tblborder">CBN</td>
                    <td class="tblborder">@if(session('month') == 'OCTOBER' && session('year') == 2019) {{'NILL'}} @else {{number_format($nhis,2)}} @endif</td>
                     <td class="tblborder"></td>
                    <td class="tblborder">{{session('month')}}  {{session('year')}}  DEDUCTION</td>  
                  </tr>
                  ...
                  @if(isset($staffDeductionElement) && $staffDeductionElement)
                    ...
                    @php $totalCVAmount += $cvItem->staffEarnings; @endphp
                      <tr>
                        ...
                        <td class="tblborder">{{number_format($cvItem->staffEarnings, 2)}}</td> 
                        <td class="tblborder"></td>
                        <td class="tblborder">{{session('month')}}  {{session('year')}}  DEDUCTION</td>  
                    </tr>
                    @endforeach
                  @endif
                  {{-- $coopSumSaving + $coopSumLoan 
                  <tr>
                    <td class="tblborder"></td>
                  ...
                  <tr>
                    ...
                    <td colspan ="3" class="tblborder"><strong>  {{number_format($totalCVAmount + $nhis + $taxSum + $unionSum,2)}} </strong</td>
                  </tr>
                  <tr>
                    <td colspan ="5"class="tblborder"><strong>GRAND TOTAL</></td>
                  
                    <td colspan ="3" class="tblborder"><strong>  {{number_format($totalCVAmount + $nhis + $taxSum + $unionSum + $sum ,2)}} </strong</td>
