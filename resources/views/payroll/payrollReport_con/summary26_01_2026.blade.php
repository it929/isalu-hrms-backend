            ...
            <table class="table-condense table-responsive table" border="1" cellpadding="4" cellspacing="0">
                ...
                @foreach ($payroll_detail as $reports)
                    ...
                    <tr>
                        ...
                        <td width="82" align="right"><?php $netpaytotal += $reports->NetPay - ($reports->PEC + $reports->PECFG); ?>
                            @if ($reports->employment_type == 5)
                        ...
                        <td width="82" align="right" valign="middle">
                            ...
                            {{ $reports->employment_type == 5 ? 0.0 : number_format($reports->PEC, 2, '.', ',') }}
                        </td>
                        <td width="82" align="right" valign="middle">
                            <?php $pectotalFG += $reports->employment_type == 5 ? 0 : $reports->PECFG; ?>
                            {{ $reports->employment_type == 5 ? 0.0 : number_format($reports->PECFG, 2, '.', ',') }}
                        </td>
