...
<body style="margin: 20px;">
    ...
    <div class="print-container watermark-container">
        ...
        <div class="row">
            ...
            <div class="input-sm">
                ...
                <div class="col-xs-10">
                    <div>
                        <h4 class="text-success text-center RefD"><strong>ISALU HOSPITAL LIMITED</strong>
                        </h4>
        ...
        <div class="row">
            <div class="col-md-12" style="text-align: centerr">
                <div class="table-responsivee">
                    <table class="table" id="tableData">
                        <thead>
                            <tr>
                                ...
                                @if($mandate[0]->contract_typeID == 1)<th class="tblborder"
                                    style="background-color:green !important; color:#fff !important;">Account Name</th>
                                @endif
                                <th class="tblborder"
                        ...
                        <tbody>
                            ...
                            @foreach ($mandate as $reports)
                                ...
                                <tr class="tblborder">
                                    ...
                                    @if($mandate[0]->contract_typeID == 1)
                                        <td class="tblborder text-left">{{ $reports->accountName }}</td>
                                    @endif
                        ...
                        @if (count($mandate) > 0)
                            <tr class="tblborder">
                                ...
                                <td class="tblborder" align="right"
                                    ...
                                    <strong
                                        style="color: #fff !important;">{{ number_format($sum, 2) }}
                                    </strong>
                                </td>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <div class="no-printt" align="right">
                               ...
                               <b> Batch Total: &#8358;{{ number_format($sum, 2) }} &nbsp;&nbsp; (<span id="result"></span> ONLY ) </b>
                            </div>
                            <?php
                            $finalsum = 0;
                            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-success hidden-print" id="exportSingleBatchRegeneratedEpayment">
                                    Export To Excel
                                </button>
                            </div>
                        </td>
                    ...
                    <form id="singleBatchRegeneratedForm" method="POST" action="{{ url('/export/singlebatchRegeratedEpayment') }}">
                        @csrf
    ...
    <script>
        ...
        $("#exportSingleBatchRegeneratedEpayment").click(function () {
            $("#singleBatchRegeneratedForm").submit();
