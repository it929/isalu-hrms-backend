...
use Auth;
use Session;
class AuditUnitControllerNew extends Controller 
{
    ...
    public function auditingU(Request $request)
     ...
     public function assignStaff()
     {
      ...
      //dd($data['ifPushed']);
       return view('auditNew.assignStaff',$data);
     ...
     public function assignRecords()
     {
      ...
      $data['assigned']=DB::table('tblpayment_consolidated')
       ...
       ->get();
        ...
        return view('auditNew.records',$data);
     ...
     public function report(Request $request)
     {
       ...
       ->groupBy('year')
       ->get();
       return view('auditNew.salaryAuditReport',$data);
     }
