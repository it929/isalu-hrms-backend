    ...
    <div class="box box-default" style="padding-bottom:0px; margin-bottom:0px;padding-top:0px; margin-top:0px;">
        <div class="box-body box-profile">
            ...
            <div class="box-body" style="padding-bottom:0px; margin-bottom:0px;">
                <div class="row">
                    <div class="col-md-2"><img src="{{ asset('assets/image-logo/njc-logo.jpg') }}"
                            class="img-responsive responsive" style="width:100%; height:auto;"></div>
                    <div class="col-md-8">
                        <div>
                            <h3 class="text-success text-center"><strong>ISALU HOSPITAL LIMITED</strong></h3>
                            <h4 class="text-center text-success"><strong>ISALU HOSPITAL LIMITED</strong>
                            </h4>
                            <h4 class="text-center text-success"><strong>Approval/Action Comments</strong></h4>
                        </div>
                    </div>
                    <div class="col-md-2"><img src="{{ asset('assets/image-logo/coat.jpg') }}"
                            class="img-responsive responsive" style="width:100%; height:120px;"></div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12"><!--1st col-->
                        ...
                        <div class="panel panel-default"
                            style="padding-bottom:0px; margin-bottom:10px;padding-top:0px; margin-top:20px;">
                                ...
                                <table class="table table-striped table-hover table-responsive table-condensed">
                                    <tbody class="btn-lg">
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>{{number_format($contract->awarded_amount, 2, '.', ',')}}</td> --}}
                                            <td>{{ isset($contract->awarded_amount) ? number_format($contract->awarded_amount, 2, '.', ',') : 'N/A' }}
                                            </td>
                                        </tr>
                        ...
                        @foreach ($comments as $b)
                            <div class="panel panel-default">
                                <div class="panel-heading fieldset-preview">
                                    <b>
                                        Comment by: {{ $b->name }}
                                        on {{ date('F j, Y', strtotime($b->comment_created_at)) }}
                                    </b>
                                </div>
