...
<table class="table table-condense table-responsive" border="1" cellpadding="4" cellspacing="0">
  ...
  <tr>
    ...
    <td width="75" align="center" valign ="middle"><strong> JUSU </strong></td>
   ...
   @php
    ...
    <td align="right" >{{ $k++ }}</td>
      ...
      <td align="right">
          ...
          <?php $medAllowanceTotal += ($reports->callduty + $reports->hazard + $reports->PEC);?>


          {{ number_format(($reports->callduty + $reports->hazard + $reports->PEC),2)}}
          @else
          0.00
          @endif
      </td>
      ...
      <td width="41" align="right" valign="middle"><?php $pectotal +=($reports->employment_type == 5)?0: $reports->PEC;?>
          @if($reports->employment_type == 5 || $reports->employment_type == 8 || $reports->employment_type == 9)
          0.00
          @else
      ...
      <?php $earntotal += $reports->TEarn - (($reports->callduty + $reports->hazard + $reports->SOT));?> <strong>{{number_format($reports->TEarn-(($reports->callduty + $reports->hazard + $reports->SOT)), 2, '.', ',')}} </strong>
      </td>
