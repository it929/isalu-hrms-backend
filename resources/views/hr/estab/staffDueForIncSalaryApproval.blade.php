...
@section('content')
                            ...
                            @if (count($variationList) > 0)
                                @foreach ($variationList as $list)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route("incrementApprovedByAudit", [$list->staffID, $list->ID])}}" class="btn btn-success btn-sm">Add Staff Variation</a>
    ...
    <form method="post" action="{{ url('/da-send-increment-to-audit') }}">
        ...
        <form method="post" action="{{ url('/salary-decline-increment') }}">
        {{ csrf_field() }}
