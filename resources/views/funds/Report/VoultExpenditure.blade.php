                                ...
                                <div class="form-group">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" value="{{ $fromdate }}"
                                            name="fromdate" id="dateFrom">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="control-label">Date To</label>
                                        <input type="text" class="form-control" value="{{ $todate }}"
                                            name="todate" id="dateTo">
                                    </div>

                                    <div class="col-md-2">
                                        <label>Allocation Source</label>
                                        <select name="allocationsource" id="allocationsource" class="form-control"
                                            onchange="ReloadForm();">
                                            <option value="" selected>-All-</option>
                                            @foreach ($AllocationSource as $b)
                                                <option value="{{ $b->ID }}"
                                                    {{ $allocationsource == $b->ID ? 'selected' : '' }}>
                                                    {{ $b->allocation }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="economichead" id="economichead" class="form-control"
                                            ...
                                            @foreach ($EconomicHead as $b)
                                                <option value="{{ $b->ID }}"
                                                    {{ $economichead == $b->ID ? 'selected' : '' }}>{{ $b->economicHead }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach ($QueryVoultReport as $b)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align">
                                            {{ number_format($b->January - ($b->bookonhold + $b->expend), 2) }}</td>
                                        <td class="align">{{ number_format($b->bookonholdtodate + $b->expendtodate, 2) }}
                                        </td>
                                        <td class="align">
