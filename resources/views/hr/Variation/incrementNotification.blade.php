			...
			<div class="col-md-12">
				<table class="table table-striped table-condensed table-bordered input-sm">
                    ...
                    @foreach($getCentralList as $key=>$list)
                     ...
                     @if(($list->grade == 17 && $list->step == 9)  || ($list->grade < 17 && $list->step == 15))
        ...
        <div class="modal-content">
          ...
          <input type="hidden" name="staffid" id="staffid">
           <input type="hidden" name="staffCode" id="staffCode" value="VO">
            ...
            <input type="hidden" name="dueDate" class="form-control" id="dueDates" />
           </div>
...
<script type="text/javascript">
 ...
 if(grade == '')
 {
  ...
  {
  $('#message').html('<div class="alert alert-danger alert-dismissible" role="alert"><strong>Please, Choose whether it is Conversion or Advancement</strong> </div> ');
  }
  else if(postcon == '')
  {
