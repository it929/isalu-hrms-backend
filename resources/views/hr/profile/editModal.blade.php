        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary" style="color:#fff;">
                ...
                <h4 class="modal-title">
                    <i class="fa fa-image"></i> Profile Picture Update
                </h4>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal"
                              action="{{ url('/profile/picture-update') }}"
                              method="post"
                              enctype="multipart/form-data">

                            {{ csrf_field() }}

                            <input type="hidden" id="PfileID" name="fileNo" value="">

                            <div class="form-group">
                                <label class="control-label col-sm-4">Profile Picture</label>
                                <div class="col-sm-8">
                                    <input type="file" name="filename" class="form-control" required onchange="EnableField1()">
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <form class="form-horizontal"
            ...
            <div class="modal-header bg-primary" style="color:#fff;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">
                    <i class="fa fa-user"></i> Biodata Profile
                </h4>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="divs" name="division">
                                            @foreach ($getDivision as $list)
                ...
                <div class="panel panel-primary" style="border-radius:6px;">
                    <div class="panel-heading">
                        <h4 class="panel-title" style="color:#fff;">
                            <i class="fa fa-user"></i> Biodata Information
                        </h4>
                    </div>
