			...
			<div class="col-md-12">
				...
				<table class="table table-bordered ">
                                                   ...
                                                   @endphp
                                                    ...
                                                    @foreach($shortlisted as $key=>$number)
                                                    @php
                                                    $staff = DB::table('tblper')->where('ID','=',$number->staffid)->first();
                                                    $id = DB::table('tblvariation_temp')->where('staffid','=',$number->staffid)->first();
                                                    if(empty($id))
                                                    {
                                                    $staffid = 0;
                                                    }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($number->variation_progress == 1)
                                                            <a href="javascript:void()" id="edit" grade="{{$staff->grade}}" step="{{$staff->step}}" staffid="{{$number->staffid}}" class="btn btn-success">Edit</a>
                                                            @else
                                                          <a href="javascript:void()" id="process" grade="{{$staff->grade}}" step="{{$staff->step}}" staffid="{{$number->staffid}}" class="btn btn-success">Process</a>
                                                          @endif
                                                          |
                                                          @if($number->stage_from == $currentUserStage && $staffid==$number->staffid)
                                                          <a href="javascript:void()" id="reverse" grade="{{$staff->grade}}" step="{{$staff->step}}" staffid="{{$number->staffid}}" class="btn btn-success">Reverse</a>
                                                          @else
                                                           <a href="javascript:void()" id="push" grade="{{$staff->grade}}" step="{{$staff->step}}" staffid="{{$number->staffid}}" class="btn btn-success">Push</a>
                                                          @endif
                                                        </td>
                                                    </tr>
