...
class AuditUnitControllerTest extends Controller
{
    ...
    public function assignStaff()
    {
        ...
        $data['ifPushed'] = DB::table('tblpayment_consolidated')
            ->where('vstage', '=', 3)
            ->groupBy('month')
            ->groupBy('year')
            ->where('audit_view', '=', 1)
       ...
       */
        ...
        //dd($data['ifPushed']);
        return view('auditTest.assignStaff', $data);
    }
    ...
    public function assignRecords()
    {
        ...
        return view('auditTest.records', $data);
    }
    ...
    public function report(Request $request)
    {
        ...
        $data['report'] = DB::table('tblpayment_consolidated')
            ...
            ->groupBy('year')
            ->get();
        return view('auditTest.salaryAuditReport', $data);
    }
