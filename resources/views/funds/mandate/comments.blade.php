                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        <div>
                            ...
                            <h4 class="text-center text-success"><strong>ISALU HOSPITAL LIMITED, THREE ARMS ZONE, CENTRAL DISTRICT PMB 308, ABUJA</strong>
                            </h4>
                            <h4 class="text-center text-success"><strong>Approval/Action Minutes</strong></h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12"><!--1st col-->
                        @if (count($cmt) == 0)
                            <div class="panel panel-default">
                                <div class="panel-heading fieldset-preview"><b>Awaiting</b></div>
                            ...
                            @foreach ($cmt as $b)
                                <div class="panel panel-default">
                                    <div class="panel-heading fieldset-preview"><b>Comment by: {{ $b->name }} on
                                            {{ date('F j, Y', strtotime($b->updated_at)) }}
                                            {{ date('g:i a', strtotime($b->updated_at)) }}</b></div>
                                    <div class="panel-body">
                                        {{ $b->comment }}
                                        <div class="clearfix"></div>
                                    </div>
