    ...
    <div class="box-body" id="main" style="background: #fff;">
        <div style="margin: 0 10px;" id="report2">
            <style type="text/css">
                ...
                $baseVoucherNo = (int) $personnelVoucher->vref_no;
                ...
                if ($personnelVoucher->WHTValue > 0) {
                    $voucherOffsets['wht'] = $currentOffset++;
                }

                if ($personnelVoucher->VATValue > 0) {
                    $voucherOffsets['vat'] = $currentOffset++;
                }

                if ($personnelVoucher->stampduty > 0) {
                ...
                <div class="row">
                    <div class="col-md-6 fla11a">
                        <div align="left" style="font-weight: 100">
                            Deptal No. <b>SCN/PE/<input type="text" class="noborder"
                                    datePrepaid="{{ date_format(date_create($personnelVoucher->datePrepared), 'Y') }}"
                                    style="border:none; width:50px !important;" transid="{{ $personnelVoucher->transID }}"
                                    id="vref"
                                    value="{{ $personnelVoucher->vref_no }}" />/{{ date('Y', strtotime(trim($personnelVoucher->datePrepared))) }}</b>.
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <table class="table table-borderedd text-center table-condensed" style="font-size: 10px">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>0</td>
                                    <td>0</td>
                                    @foreach (str_split($personnelVoucher->economicCode) as $char)
                                        <td>{{ $char }}</td>
                                    @endforeach
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    @foreach (str_split(str_replace('-', '', date_format(date_create($personnelVoucher->datePrepared), 'd-m-y'))) as $char)
                                        <td>{{ $char }}</td>
                                    @endforeach
                                    <td colspan="14">
                                        <b>&#8358;{{ number_format($personnelVoucher->amtPayable, 2, '.', ',') }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                    ...
                    <div class="col-md-3 frra1">
                        ...
                        <table class="table table-borderedd input-sm" style="font-size: 9px">
                            ...
                            <tr>
                                <td>S/Head</td>
                                <td>{{ substr($personnelVoucher->Code, 0, 4) }} {{ $personnelVoucher->economicCode }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    <td width="150" rowspan="2">
                                        {{ date_format(date_create($personnelVoucher->datePrepared), 'd-m-Y') }}

                                    </td>
                                    <td width="650">
                                        <div align="left">
                                            {{ $personnelVoucher->paymentDescription }}
                                    ...
                                    <td></td>
                                    <td height="20">
                                        <b><big>{{ number_format($personnelVoucher->amtPayable, 2, '.', ',') }}</big></b>
                                        <?php $amtpayable = $personnelVoucher->amtPayable; ?>
                                ...
                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <strong>
                                                            &#8358;{{ number_format($personnelVoucher->amtPayable, 2, '.', ',') }}</strong>
                                                    </div>
                                                </div>
                                                ...
                                                {{-- @if ($personnelVoucher->companyID != 13) --}}
                                                {{-- @if ($balance1 > 0)
                                        <tr>
                                    ...
                                    <td style="vertical-align: bottom;">
                                        <big><strong>{{ number_format($personnelVoucher->amtPayable, 2, '.', ',') }}</strong></big>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="verificationVoucher">
                ...
                <div class="row">
                    <div class="col-md-8 vla11a">
                        <div align="left" style="font-weight: 100">
                            Deptal No.
                            <b>SCN/{{$personnelVoucher->contractTypeID == 6 ? 'PE' : 'OC'}}/{{ formatVoucherNo($baseVoucherNo) }}/{{ date('Y', strtotime(trim($personnelVoucher->datePrepared))) }}</b>.
                            <div style="text-decoration: none; border-bottom: 2px dotted #000;">
                                <strong>Payee:</strong> &nbsp;&nbsp;&nbsp; <span class="input-lg">
                                    @if ($personnelVoucher->companyID == 13)
                                        {{ $personnelVoucher->payment_beneficiary }}
                                    @else
                                        {{ $personnelVoucher->contractor }}
                                    @endif
                                </span>
                            </div>
                                    ...
                                    <td>
                                        <table class="input-sm" style="width:100%;">
                                            <tbody>
                                                ...
                                                {{-- @if ($personnelVoucher->premiumcharge > 0)
                                                    <div
                                                        style="display: flex; justify-content: space-between; align-items: center;">
                                                        <div width="200"
                                                        ...
                                                        <div
                                                            ...
                                                            &#8358;{{ number_format($personnelVoucher->totalPayment - $personnelVoucher->premiumcharge, 2, '.', ',') }}
                                                        </div>
                                                    </div>
                                                @else
                                                    <div
                                                ...
                                                @if ($personnelVoucher->VAT > 0)
                                                    <div
                                                        style="display: flex; justify-content: space-between; align-items: center;">

                                                        <div style="text-align: left; height: 30px; padding: 0px 4px;">
                                                            Less {{ $personnelVoucher->VAT }}% VAT Payable
                                                        </div>

                                                        <div style="text-align: right; padding: 0 4px;">
                                                            &#8358;
                                                            @if ($personnelVoucher->VATValue == 0)
                                                                {{ $personnelVoucher->VATValue }}
                                                            @else
                                                                {{ number_format($personnelVoucher->VATValue, 2, '.', ',') }}
                                                            @endif
                                                        </div>
                                                ...
                                                @if ($personnelVoucher->WHT > 0)
                                                    <div
                                                        style="display: flex; justify-content: space-between; align-items: center;">
                                                        <div
                                                            style="border: none !important; width:200; text-align: left; height: 30px; padding: 0px 4px;">
                                                            Less {{ $personnelVoucher->WHT }}% W/H Tax</div>
                                                        <div
                                                            style="border: none !important; text-align: right; padding: 0px 4px;">
                                                            &#8358;
                                                            @if ($personnelVoucher->WHTValue == 0)
                                                                {{ $personnelVoucher->WHTValue }}
                                                                @else{{ number_format($personnelVoucher->WHTValue, 2, '.', ',') }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                @if ($personnelVoucher->stampduty > 0)
                                                    <div
                                                        ...
                                                        <div
                                                            style="border: none !important; width:200; text-align: left; height: 30px; padding: 0px 4px;">
                                                            Less {{ $personnelVoucher->stampdutypercentage }}% Stamp Duty</div>
                                                        <div
                                                            style="border: none !important; text-align: right; padding: 0px 4px;">
                                                            &#8358;
                                                            @if ($personnelVoucher->stampduty == 0)
                                                                {{ $personnelVoucher->stampduty }}
                                                                @else{{ number_format($personnelVoucher->stampduty, 2, '.', ',') }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                {{-- @php $balance1 = $bbf - $personnelVoucher->totalPayment;  @endphp --}}
            ...
            @for ($i = 1; $i <= 2; $i++)
                <div class="journalMainVoucher" style="margin-top: 40px;">
                            ...
                            <table class="table table-condensed table-borderedd text-center input-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $personnelVoucher->ecoCodeDesc }}</td>
                                        <td>{{ $personnelVoucher->economicCode }}</td>
                                        <td><strong>{{ number_format($personnelVoucher->amtPayable, 2, '.', ',') }}</strong>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row padNarrationPrepared2">
                        <div class="col-md-12">
                            <p>NARRATION: <span> {{ $personnelVoucher->paymentDescription }}</span></p>
                        </div>
                    </div>
            ...
            <?php
            $count = DB::table('tblvoucherBeneficiary')->where('voucherID', '=', $personnelVoucher->transID)->count();

            $staff = DB::table('tblvoucherBeneficiary')->leftJoin('tblbanklist', 'tblbanklist.bankID', '=', 'tblvoucherBeneficiary.bankID')->where('voucherID', '=', $personnelVoucher->transID)->get();
            ?>
            {{-- beneficiary --}}
            @if($count > 0)
