...
$staff1065 = DB::table('tblper')->where('ID', 1065)->first();
echo "Staff 1065 UserID: " . ($staff1065->UserID ?? 'null') . "\n";

// Let's simulate getUserContext for OLAOYE AFEEZ (UserID 10214)
$userId = 10214;
$request = new \Illuminate\Http\Request();
$request->headers->set('X-User-Id', $userId);

$controller = new \App\Http\Controllers\Api\ResignationApiController();
// Using reflection to call getUserContext
...
// Run the index query logic for UserID 10214
