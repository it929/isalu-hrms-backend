...
class ConSalarySetupController extends ParentController
{
    ...
    public function create(Request $request)
    {
        ...
        //$data['scale'] ='';
        $data['scale'] = DB::table('basicsalaryconsolidated')
        ...
        //  dd($data);
        return view('payroll/consalarySetup/createSalary', $data);
    }
    ...
    public function display(Request $request)
    {
        ...
        $data['count'] = DB::table('basicsalaryconsolidated')
            ->where('courtID', '=', $court)
            ->where('grade', '=', $grade)
            ->where('step', '=', $step)
    ...
    public function saveSalary(Request $request)
    {
        ...
        */
        ...
        if ($btn == 'Display') {
            ...
            if ($id != '') {
                DB::table('basicsalaryconsolidated')->where('ID', $id)->update(array(
                    'amount'             => $basic,
                ...
                return redirect('/con-salary/create')->with('msg', 'updated Successfully');
            } elseif ($id == '') {
                $insert = DB::table('basicsalaryconsolidated')->insert(array(
                    'amount'             => $basic,
                    'employee_type'      => $empType,
                    'courtID'            => $court,
                    'grade'              => $grade,
                ...
                return redirect('/con-salary/create')->with('msg', 'Added Successfully');
            }
        }
    }
