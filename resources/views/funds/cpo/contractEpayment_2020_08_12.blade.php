...
<body onload="lookup();">
    ...
    <div class="col-md-12">
        ...
        <div style="öpacity:0.2; width:100%; float:left;">
            ...
            <table class="table table-responsive table-bordered" id="tableData">
                ...
                @foreach ($mandate as $reports)
                    <tr class="tblborder">
                        ...
                        <td class="tblborder" align="right"> {{ number_format($reports->totalAmount, 2, '.', ',') }}
                        </td>
                ...
                <tbody>
                    ...
                    @foreach ($breakdown as $list)
                        ...
                        <tr>
                            ...
                            <td><?php $totalCBN += $list->amount; ?>{{ number_format($list->amount, 2) }}</td>
                            <td>CR</td>
                            <td>{{ $list->purpose }}</td>
                            <td>NJC Payment</td>
                            <td>{{ $list->date }}</td>
