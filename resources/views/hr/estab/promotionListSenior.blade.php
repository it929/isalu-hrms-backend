    ...
    <div class="box box-default" style="border-top: none;">
        ...
        <div class="box-header with-border hidden-print">
            <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span
                    id='processing'><strong><em>Senior Staff Promotion Notification.</em></strong></span></h3>
        </div>
            ...
            <div class="box-body" style="background: white;">
                <div class="row">
                    <div class="col-md-12" style="margin-bottom: 10px;">
                        <form method="post"
                            action="{{ Route::has('promotionSearchSenior') ? Route('promotionSearchSenior') : '#' }}">
                        ...
                        <tbody>
                            @foreach ($getCentralList as $key => $list)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $promotionDate = strtotime($newPromotionDate[$list->ID]);
                                            $formattedDate = date('d-m-Y', $promotionDate);
                                        ...
                                        @else
                                            <span class="label label-success"><i class="fa fa-calendar"></i> Upcoming</span>
                                        @endif
                                    </td>
