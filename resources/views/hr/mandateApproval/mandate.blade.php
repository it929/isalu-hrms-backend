 ...
 @foreach($epayment_detail as $list)
  ...
  else
  {
       ...
       $nhisVal = $nhis;
                  ...
                  $t = $refundSum + $nhisVal + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum + $totalPaySum;
                  //$tots  = $sum1 + $t;
                  ?>
            ...
            <table class="table table-responsive table-bordered" id="tableData">
                 ...
                 <?php
                  ...
                  <tr>
                    ...
                    <td colspan ="3" class="tblborder"><strong> @if(session('month') == 'OCTOBER' && session('year') == 2019) {{number_format($refundSum + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum,2)}}  @else {{number_format($refundSum + $nhis + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum,2)}} @endif</strong</td>

                  </tr>
                  <tr>
                    <td colspan ="5"class="tblborder"><strong>GRAND TOTAL</></td>

                    <td colspan ="3" class="tblborder"><strong>@if(session('month') == 'OCTOBER' && session('year') == 2019) {{number_format($refundSum + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum + $sum ,2)}}  @else {{number_format($refundSum + $nhis + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum + $sum ,2)}} @endif</strong</td>
