        ...
        <tr>
          <td colspan="2">
            <table class="table table-responsive table-bordered">
                  ...
                  $sum =0;?>
                  <?php
                  $sig1 = DB::table('tblmandatesignatory')->join('tblmandatesignatoryprofiles','tblmandatesignatoryprofiles.id','=','tblmandatesignatory.id')->where('tblmandatesignatory.id','=',1)->first();
                   $sig2 = DB::table('tblmandatesignatory')->join('tblmandatesignatoryprofiles','tblmandatesignatoryprofiles.id','=','tblmandatesignatory.id')->where('tblmandatesignatory.id','=',2)->first();
                  $subTotal=0;
                  $bkID ='';
                  ?>
