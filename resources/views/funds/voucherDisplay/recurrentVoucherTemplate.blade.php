    ...
    <div class="row">
        <div class="col-md-6 fla11a">
            <div align="left" style="font-weight: 100">
                Deptal No. <b>SCN/OC/<input type="text" class="noborder"
    ...
    <div class="withHoldTaxVoucher">
        ...
        <div class="row">
            <div class="col-md-6 fla11a">
                ...
                <div align="left" style="font-weight: 100">
                    Deptal No. <b>SCN/OC/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['wht']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
            </div>
            <div class="col-md-6 fra11b">
                                    ...
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>
                                                    &#8358;{{ number_format($list->WHTValue, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>

                                        <div>
                                            Checked and Passed for &nbsp;&nbsp;&nbsp;&nbsp; <h6><strong> <span
                                                        id="resultTAX3"></span></strong></h6>
    ...
    <div class="vatVoucher">
        ...
        <div class="row">
            <div class="col-md-6 fla11a">
                ...
                <div align="left" style="font-weight: 100">
                    Deptal No. <b>SCN/OC/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['vat']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
            </div>
            <div class="col-md-6 fra11b">
                                    ...
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>
                                                    &#8358;{{ number_format($list->VATValue, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>

                                        <div>
                                            Checked and Passed for &nbsp;&nbsp;&nbsp;&nbsp; <h6><strong> <span
                                                        id="resultVAT3"></span></strong></h6>
    ...
    <div class="stampDutyVoucher">
        ...
        <div class="row">
            <div class="col-md-6 fla11a">
                ...
                <div align="left" style="font-weight: 100">
                    Deptal No. <b>SCN/OC/{{ formatVoucherNo($baseVoucherNo + $voucherOffsets['stamp']) }}/{{ date('Y', strtotime(trim($list->datePrepared))) }}</b>.
                </div>
                @endif
            </div>
            <div class="col-md-6 fra11b">
                ...
                <table class="table table-condensed table-borderedd text-center input-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="650">
                                <div align="left">
                                    Being {{ $list->stampdutypercentage > 0 ? $list->stampdutypercentage : '' }}% deducted from @if ($list->companyID == 13)
                                        {{ $list->payment_beneficiary }}
                                    @else
                                        {{ $list->contractor }}
                                    @endif Vide attached document in File .......... Gross
                                    ...
                                    <tbody>
                                        ...
                                        <div
                                            ...
                                            <div
                                                style="border: none !important; text-align: right; border-bottom: 2px solid #000; border-top: 2px solid #000;  padding: 0px 4px;">
                                                <strong>
                                                    &#8358;{{ number_format($list->stampduty, 2, '.', ',') }}</strong>
                                            </div>
                                        </div>

                                        <div>
                                            Checked and Passed for &nbsp;&nbsp;&nbsp;&nbsp; <h6><strong> <span
                                                        id="resultSTAMP3"></span></strong></h6>
