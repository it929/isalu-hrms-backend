...
@section('content')
    ...
    @include('hr.Layouts.promotionalert')
                    ...
                    <tbody>
                        ...
                        @foreach ($getCentralList as $list)
                            <tr>
                                ...
                                <td>
                                    @php
                                        if (strtoupper($list->gender == 'MALE')) {
                                            $sex = 'M';
                                        } elseif (strtoupper($list->gender == 'FEMALE')) {
                                            $sex = 'F';
                                        } else {
                                            $sex = '';
                                        }
                                ...
                                @include('hr.Layouts.promotion')

                                @include('hr.Layouts.link')
...
@section('scripts')
        ...
        $(function() {
            ...
            $(".adv").on('click', function() {
                ...
                if (grade == '') {
                    ...
                    $('#message').html(
                        '<div class="alert alert-danger alert-dismissible" role="alert"><strong>Please, Type in the Recommendation</strong> </div>'
                        );
                } else {
                    //$('#msg').html(fileNo);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("table tr td input[name=confirm]").on('click', function() {
                //alert("ok");
