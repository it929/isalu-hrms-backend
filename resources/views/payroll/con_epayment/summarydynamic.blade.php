          ...
          <td colspan="2">
            <table class="table table-responsive table-bordered">
                  ...
                  <td class="tblborder"> {{$counter}}</td>
                    ...
                    <td class="tblborder" >@if($bkID=='6') 0018068474 @elseif($bkID=='33')  0001478903 @else @endif
                 ...
                 <?php
                  ...
                  <tr class="tblborder">
                    ...
                    <td class="tblborder">  @if($reports->remarks!=null) {{$reports->remarks}} @else {{session('month')}}  {{session('year') }} Staff Salary @endif </td>
                  </tr>
                   <?php $counter=$counter+1;   ?>
                  @endif
                  <?php
        ...
        <tr>
          <td colspan="2">
            <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="no-border" align="left">Name: {{$dt->Name}}</td>
			...
			Date:</td>
                    ...
                    <tr>
                      <td class="no-border" align="left">Tel No: {{$dt->phone}}<span class="sign1"></span></td>
