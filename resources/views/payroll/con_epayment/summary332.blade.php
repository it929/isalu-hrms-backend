                            ...
                            <tr>
                                <td>
                                    <div align="left">{{ date('d/m/Y') }} <br />
                                        ...
                                        NJC/ZENITH/{{ $nmonth = date('m', strtotime($month)) }}/BAT-@if (count($bat) > 0)
                                            {{ $bat->batNo }}
                                        @else
                                        @endif <br />
                        ...
                        <table class="table table-responsive table-bordered" id="tableData">
                            ...
                            @if ($bkID != '')
                                <tr class="tblborder">
                                    ...
                                    <td colspan="3" class="tblborder"><strong> {{ number_format($subTotal, 2) }}
                                        </strong></td>
                                </tr>
                                <?php
                                $subTotal = 0;
                            ...
                            <tr>
                                ...
                                <td class="tblborder"></td>
                                <td class="tblborder">{{ session('month') }} {{ session('year') }} LOAN REMITTANCE
                                    FOR ADESOJI OYE</td>

                            </tr>

                            <tr>
                                <td colspan ="5"class="tblborder"><strong>SUB TOTAL</>
                                </td>

                                <td colspan ="3" class="tblborder">
                                    <strong>{{ number_format($refundSum + $nhis + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum, 2) }}
                                        </strong< /td>

                            </tr>
                            <tr>
                                <td colspan ="5"class="tblborder"><strong>GRAND TOTAL</>
                                </td>

                                <td colspan ="3" class="tblborder">
                                    <strong>{{ number_format($refundSum + $nhis + $taxSum + $coopSumSaving + $coopSumLoan + $unionSum + $sum, 2) }}
                                        </strong< /td>
                ...
                <tr>
                    <td colspan="2">
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="no-border" align="left"><strong>ALL DUE PROCESS COMPLIED WITH</strong>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="no-border" align="left">Name: {{ $sig1->Name }} </td><br />
                            ...
                            <tr>
                                <td class="no-border" align="left">Tel No: {{ $sig1->phone }}<span
                                        class="sign1"></span></td>
                            ...
                            <tr>
                                <td class="no-border" align="left">Name: {{ $sig2->Name }}</td>
                                <td class="no-border" rowspan="2"><img src="{{ asset('Images/sch.jpg') }}" />
                                </td>
                                <td class="no-border" align="left">Name:</td>
                            ...
                            <tr>
                                <td class="no-border" align="left">Tel No: {{ $sig2->phone }}<span
                                        class="sign3"></span>
                                </td>
                                <td class="no-border">&nbsp;</td>
