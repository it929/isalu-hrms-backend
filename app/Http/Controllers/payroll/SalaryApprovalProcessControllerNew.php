...
class SalaryApprovalProcessControllerNew extends ParentController
{
  ...
  public function viewAnalylis($month,$year,$field)
  {
    ...
    ->where('tblpayment_consolidated.month',     '=', $month)
    ->where('tblpayment_consolidated.year',      '=', $year)
    ->where("tblpayment_consolidated.$field",      '=', 0)
    ->where('tblpayment_consolidated.rank','!=',2)
 ...
 public function salaryPush()
 {
		...
		if(empty($staff))
        {
         ...
         $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('audit_view','=',1)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('audit_view','=',1)->where('employment_type','!=',2)->count();
		...
		if($staff->section == 'AU')
		{
          ...
          $data['all'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('audit_view','=',1)->count();
		    ...
		    $data['viewSal'] = DB::table('tblpayment_consolidated')
		    ->where('audit_view','=',1)
		    ->where('vstage','=',3)
		    ->groupBy('month')
		    ->groupBy('year')
		...
		elseif($staff->section == 'CK')
		{
		    ...
		    $data['view'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->value('checking_view');
		     $data['viewSal'] = DB::table('tblpayment_consolidated')
		    ->where('checking_view','=',1)
		    //->where('vstage','=',2)
		    ->where('year','=',$data['activemonth']->year)
            ->groupBy('month')
		    ->groupBy('year')
            ->get();
             $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('checking_view','=',1)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('checking_view','=',1)->where('employment_type','!=',2)->count();
           $data['all'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('checking_view','=',1)->count();
		}
		elseif($staff->section == 'CA')
		{
		    ...
		    ->groupBy('year')
		    ->get();
		    $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('ca_view','=',1)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('ca_view','=',1)->where('employment_type','!=',2)->count();
          
            $data['all'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('ca_view','=',1)->count();
		...
		elseif($staff->section == 'DR')
		{
		    ...
		    $data['view'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->value('director_view');
		     $data['viewSal'] = DB::table('tblpayment_consolidated')
		    ->where('director_view','=',1)
		    ->where('vstage','=',5)
		    ->groupBy('month')
		    ->groupBy('year')
		    ->get();
		    $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('director_view','=',1)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('director_view','=',1)->where('employment_type','!=',2)->count();
          
           $data['all'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('director_view','=',1)->count();
		...
		elseif($staff->section == 'SAL')
		{
		   ...
		   // ->where('vstage','=',0)
		    ...
		    ->get();
		     $data['all'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->count();
		    $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('employment_type','!=',2)->count();
		...
		elseif($staff->section == 'VC')
		{
		     ...
		     $data['viewSal'] = DB::table('tblpayment_consolidated')
		    ->where('variation_view','=',1)
		    
            ->get();
            
		    $data['council'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('variation_view','=',1)->where('employment_type','=',2)->count();
          $data['staff'] = DB::table('tblpayment_consolidated')->where('year','=',$data['activemonth']->year)->where('month','=',$data['activemonth']->month)->where('variation_view','=',1)->where('employment_type','!=',2)->count();
		...
		//dd()
        return view('salaryApprovalProcessNew.takeaction',$data);
 ...
 public function process(Request $request)
 {
       ...
       $vstage = 5;
        ...
        else
        {
            ...
            {
        $update = DB::table('tblpayment_consolidated')->where('employment_type','=',2)->where('year','=',$activeYear)->where('month','=',$activeMonth)->update([
            "$field"  => 1,
            'vstage'  => $vstage
            ]);
 ...
 public function create()
  {
    ...
    $data['allbanklist']  = DB::table('tblbanklist')
     ...
     return view('salaryApprovalProcessNew.index',$data);
  }
      ...
      ->first();
       $data['payroll_detail'] = $this->viewData($month,$year,$court,$bankID,"checking_view");
        foreach ($data['payroll_detail'] as $key => $value) {
		         ...
		         return view('salaryApprovalProcessNew.summary', $data);
  ...
  return view('salaryApprovalProcessNew.analysisParam',$data);
  }
  ...
  public function analysisDisplay(Request $request)
  {
   ...
   $staff = DB::table('tblstaff_section')->where('user_id','=',Auth::user()->id)->first();
    ...
    return view('salaryApprovalProcessNew.analysis',$data);
  }
      ...
      ->first();
       $data['payroll_detail'] = $this->viewData($month,$year,$court,$bankID,"checking_view");
        foreach ($data['payroll_detail'] as $key => $value) {
		         ...
		         return view('salaryApprovalProcessNew.viewSummary', $data);
  ...
  public function checkCard()
{
    ...
    //get current logged in user division if not global user
	   ...
	   if($data['CourtInfo']->divisionstatus==1 && Auth::user()->is_global==1){
	       $data['sessionDivision'] = session('current_division');
	       if($data['sessionDivision'] != ''){
	           $data['staff'] = DB::table('tblper')->where('divisionID', '=', $data['sessionDivision'])->orderBy('surname', 'ASC')->get();
	       }else{
	           $data['staff'] = DB::table('tblper')->orderBy('surname', 'ASC')->get();
	       }
	   }else{
	       //get list of staffs within the division from tblper
	       $data['staff'] = DB::table('tblper')->where('divisionID', '=', $data['curDivision']->divisionID)->orderBy('surname', 'ASC')->get();
	   }
...
//   }
	...
	return view('salaryApprovalProcessNew.conIndex',$data);
}
...
public function sessionset(Request $request)
    {
        ...
        //  }
         ...
         $ses  = Session::put('current_division', $division);
         if($ses)
         {
...
$data['details'] = DB::table('tblper')
    ...
    return view('/salaryApprovalProcessNew.conPeReport',$data);
}
 ...
 public function loadView()
   {
		...
		$data['workingstate'] = DB::table('tblstates')
	     ...
	     $data['cvSetup'] = DB::table('tblcvSetup')->select('ID', 'description')->get();
            ...
            //->union($cvSetup)
            ->get();
   	    return view('salaryApprovalProcessNew.treasury', $data);
   }
   ...
   public function view(Request $request)
    { 
		...
		return view('salaryApprovalProcessNew.treasuryReport', $data);
		//dd($reportess);
	...
	$List= DB::Select("SELECT * $vpara FROM `tblpayment_consolidated` WHERE `tblpayment_consolidated`.$field = 0 and `year`='$year' and `month`='$month' and $qbank and $qpara and rank<>2 and $qresidential order by rank DESC, grade DESC, step DESC");
	//dd($List);
	return $List;
	}
	...
	public function displayComments($year,$month)
    {
        $data['cmt'] = DB::table('tblsalary_comments')
                    ...
                    ->select('*','tblsalary_comments.updated_at as dateUpdated')
                    ->get();
                   
                    return view('salaryApprovalProcessNew.comments',$data);
    }
  ...
  public function bankSchedule()
  {
      ...
      return view('salaryApprovalProcessNew.bankSchedule',$data);
  }
  
  public function postBankSchedule(Request $request)
  {
    $data['epayment_detail'] = [];
    $data['epayment_total'] = [];
    $month     = trim($request->input('month'));
    $year      = trim($request->input('year'));
  ...
  /*$data['group'] = DB::table('tblpayment_consolidated')
    ...
    return view('salaryApprovalProcessNew.viewBankShedule',$data);
  }
  ...
  public function report(Request $request)
  {
      $currentYear = date('Y');
       if ($request->isMethod('post')) {
            $data['report'] = DB::table('tblsalary_comments')
                        ->where('year','=',$currentYear)
                        ->where('by_who','=',Auth::user()->id)
                        ->orderBy('ID')
                        ->get();
