                                ...
                                @foreach ($shortlisted as $key => $list)
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-print">
                                            ...
                                            @if ($list->status == 1 && $list->progress_stage == 1 && $list->approval_status == 2)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-warning" style="border-left: 5px solid #d9534f; padding-left:15px;">
                            <h5 style="margin-top:0;">
                                <i class="fa fa-exclamation-triangle"></i> Important Notice
                            </h5>
                            <p style="margin-bottom:0;">
                                Once approved, this staff record will be forwarded to
                                <strong>Admin</strong> for entering candidate scores.
                            </p>
                        </div>
