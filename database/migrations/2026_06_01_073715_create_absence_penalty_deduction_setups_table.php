...
class CreateAbsencePenaltyDeductionSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('absence_penalty_deduction_setups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('absence_penalty_deduction_setups');
    }
}
