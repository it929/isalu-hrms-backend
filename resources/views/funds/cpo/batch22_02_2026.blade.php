                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="padding: 2px;">
                                    ...
                                    <input type="text" name="voucherNumber" class="form-control"
                                        value='{{ session('vrefNo') }}' placeholder="Search By Voucher Number">
                                </div>
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($audited as $list)
                                        <tr>
                                            <td>{{ $key++ }}</td>
                                            <td> {{ $list->adjusted_batch }} ({{$list->batch_count}} Batch{{$list->batch_count > 1 ? 'es' : ''}})<br> Voucher No. {{ $list->voucherFileNo ?? '' }} </td>
                                            <td class="text-center">
                                                {{ number_format($list->sum + $list->vsum + $list->wsum, 2) }}</td>
                                            ...
                                            {{-- <td class="hidden-print">
                                                ...
                                                @else
                                                    <a href="#" class="btn btn-success btn-xs"> Payment Made </a>
                                                @endif
                                            </td> --}}
        ...
        <div id="markAsPaidModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Payment Bank Confirmation</h4>
                    </div>
                    <div class="modal-body">
                    ...
                    Payment amount of XXXXX has been  processed from bank
                    </textarea>
                            </div>
