          ...
          <table width="1122" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <table border="1" class="table table-bordered table-hover">
              <tr>
                ...
                <th class="text-center">Leave Grant</th>
                ...
                <th class="text-center">Servant</th>
              ...
              <tr>
                ...
                <td align="right">{{ number_format($reports->leave_bonus, 2, '.', ',') }}</td>
                <td align="right">{{ number_format($reports->peculiar, 2, '.', ',') }}</td>
                <td align="right">{{ number_format($reports->housing, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->transport, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->utility, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->furniture, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->meal, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->driver, 2, '.', ',')  }}</td>
                <td align="right">{{ number_format($reports->servant, 2, '.', ',')  }}</td>
