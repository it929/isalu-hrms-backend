...
<div align="left"><strong>
  ...
  <tr>
    ...
    <!--<td><?php $totalAllowance += $list->totAllowance;?>{{number_format($list->totAllowance,2)}}</td>-->
<td><?php $totalAllowance += $list->totAllowance;?>{{number_format((($list->netpay+$list->totdeduct)-$list->basic),2)}}</td>
    ...
    <td><?php $cooptotal += $list->coop2;?> {{number_format($list->coop2,2)}} </td>
    <td><?php $saladvtotal += $list->saladv;?> {{number_format($list->saladv,2)}} </td>
    <td ><?php $hstotal += $list->hloan;?> {{number_format($list->hloan,2)}} </td>
  ...
  @endforeach
    ...
    <td><strong> {{number_format($saladvtotal ,2)}} </strong></td>
    <td ><strong> {{number_format($hstotal ,2)}} </strong></td>
