        ...
        <tr>
          <td colspan="2">
            <table class="table table-responsive table-bordered">
                  ...
                  $k = 1;
                  ?>  
                  @foreach ($epayment as $reports)
                  <tr class="tblborder">
                    <td class="tblborder"> {{$k++}}</td>
                    ...
                    <td class="tblborder"> {{$sortCode}}</td>
                    <td class="tblborder">  {{$month}}  {{$year }} Staff Arrears  </td>
                  </tr>  
                  <?php 
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td class="no-border" align="left" valign="top">Signature: <br />
                            ...
                            <tr>
                              <td class="no-border" align="left">Tel No: <span class="sign1">{{$phone1}}Hauwa</span></td>
                              <td class="no-border">&nbsp;</td>
                              <td class="no-border" colspan="2" align="left">Tel No: <span class="sign2">{{$phone2}}Ige</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td class="no-border" valign="top" align="left">Signature:<br />
                                ...
                                <tr>
                                  <td class="no-border" align="left">Tel No: <span class="sign3">{{$phone3}} balogun</span>
                                  </td>
                                  <td class="no-border">&nbsp;</td>
