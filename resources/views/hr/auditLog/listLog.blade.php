...
<div class="box box-default" style="border-top: none;">
  ...
  <div class="box-body">
    ...
    <div class="row" style="margin-top:5px; padding-top: 15px; padding-left: 30px; padding-right: 30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="dateFrom" id="getFrom" class="form-control input-lg"  value="{{ Session::get('date_from') }} {{old('dateFrom')}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="date">End Date</label>
                            <input type="text" name="dateTo" id="getTo" class="form-control input-lg"  value="{{ Session::get('date_to') }} {{old('dateTo')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label >&nbsp;</label>
                            <div>
                                <input type="submit" name="submit" value="Display" class="btn btn-success input-lg" style="border: #333; border-radius: 0; outline: none !important; margin-left: -25px; padding: 8px;"/>
        ...
        <div class="hidden-print pagination">{{$getLog->links()}} </div>
      </div>
    </div>
    <!-- /.col -->
  </div>
