...
<table class="table table-condense table-responsive" border="1" cellpadding="4" cellspacing="0">
  <tr class="th-row">
    ...
    <td rowspan="2" align="center" valign="top"><strong>JUSUN</strong></td>
    <td rowspan="2" align="center" valign="top"><strong>TOTAL AMOUNT</strong></td>


    <td colspan="4" align="center" valign="top"><strong>DEDUCTIONS</strong></td>

    <td width="70" rowspan="2" align="center" valign="middle"><strong>TOTAL DEDUCTION.</strong></td>

    <td width="75" rowspan="2" align="center" valign ="middle"><strong> </strong></td>
    <td width="75" rowspan="2" align="center" valign ="middle"><strong> TOTAL NET <BR/> EMOLUMENT </strong></td>
  </tr>
  <tr>
  <!--EARNING -->
    <td width="90" align="center" valign="middle"><strong>GROSS</strong></td>
    <td width="38" align="center" valign="middle"><strong>ARREARS </strong></td>
    <td width="52" align="center" valign="middle"><strong>OVERTIME/<BR/>ACTING ALL.</strong></td>
  ...
  <!-- DEDUCTIONS-->
    ...
    <td width="85" align="center" valign="middle"><strong>TOTAL DEDUCTION</strong></td>
    <td width="80" align="center" valign="middle"><strong></strong></td>
    <td width="80" align="center" valign="middle"><strong>TOTAL NET EMOLUMENT</strong></td>
  ...
  @foreach ($payroll_detail as $reports)
    ...
    <tr>
      ...
      <td align="left" valign="middle" nowrap="nowrap"><a target ="_blank" href="{{url("/con-pecard/getCard/$reports->staffid/$reports->year")}}">{{ $reports->name }}</a></td>
      ...
      @else
        <td width="66" align="right"><?php $e_arrearstotal += $reports->AEarn;?><a class="hidden-print" href="{{url("/con-payrollReport/arrears/$reports->courtID/$reports->staffid/$reports->year/$reports->month")}}" target="_blank">{{number_format($reports->AEarn, 2, '.', ',')}}</a></td>
      @endif
      <td width="38" align="right"><?php $e_otherstotal += $reports->OEarn;?> {{number_format($reports->OEarn, 2, '.', ',')}}</td>
      <td width="80" align="right"><?php $earntotal += $reports->TEarn;?> <strong>{{number_format($reports->TEarn - $reports->PEC, 2, '.', ',')}} </strong></td>
      ...
      @else
        <td width="85" align="right"><?php $d_arrearstotal += $reports->AD;?>
          <a class="hidden-print" href="{{url("/con-payrollReport/arrears/$reports->courtID/$reports->staffid/$reports->year/$reports->month")}}" target="_blank">
      ...
      <td width="82" align="right" ><?php $deducttotal += $reports->TD;?> <strong> {{number_format($reports->TD, 2, '.', ',')}}</strong></td>
  ...
  <tr><td colspan="4" align="right"><strong>TOTAL</strong></td>
    ...
    <td align="right"><strong>{{ number_format($totalNetEmolu + $deducttotal, 2, '.', ',') }}</strong></td>
