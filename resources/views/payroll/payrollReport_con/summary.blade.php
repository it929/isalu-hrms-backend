...
<head>
    ...
    <style type="text/css">
        ...
        @media print {
            ...
            /* Prevent rows breaking and force page break after every 30 rows in tbody */
            tbody tr { page-break-inside: avoid; break-inside: avoid; }
            /* tbody tr:nth-child(31n) { break-after: page; page-break-after: always; margin-top: 500px !important; padding-top: 500px !important; } */
        }
    </style>
    <style media="print">
        .pr {
    ...
    <div class="row">
        ...
        <div style="width:90%; margin: auto;">
            <div align="center" class="marginTableHeading">
                <h2>
                    <div style="color:#06c;"> <h3>NIGERIA FEDERAL GOVERNMENT PAYROLL</h3></div>
                </h2>
            </div>
            ...
            <table class="table-condense table-responsive table tableMarginPad" border="1" cellpadding="4" cellspacing="0">
                <thead>
                <tr class="th-row">
