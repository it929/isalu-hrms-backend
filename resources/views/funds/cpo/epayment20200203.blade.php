                ...
                <div class="row">
                    ...
                    <div align="right" class="col-xs-6">
                        <table>
                            <tr>
                                <td>
                                    <div align="left">Reference No:Per/{{ date('Y') }}/1/A<br />
                                        Code: <br />
                            ...
                            @foreach ($mandate as $reports)
                                ...
                                if ($reports->WHTValue == 0 && $reports->VATValue == 0) {
                                    ...
                                    echo '
                                        ...
                                        ' </td>
                                                                                            <td class="tblborder"></td>
                                                                                            <td class="tblborder"> FIRS Payment </td>
                                                                                            <td><a href="' .
                                        $url .
                                        '" class="btn btn-success btn-xs hidden-print" target="_blank">View Voucher</a></td>
                                                                                        </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="no-border" colspan="5">
                                    <div align="center">
                                        Please credit the account(s) of the above listed beneficiary(s) and debit our
                                        account above with: (&#8358;)<b>{{ number_format($sum + $whtsum + $vatsum, 2) }}
                                        </b><br>
                                        <span id="result"> </span>
