		  ...
		  <div class="box-body">
		        <div class="row">
		            <div class="col-md-12"><!--1st col-->
						...
						<div class="row">
						<div class="col-md-12">
							<h3 style="text-align: center;">UPGRADING TO THE POST OF @if(count($upgrade))

							
							{{strtoupper($upgrade->post_considered)}} GL.{{strtoupper($upgrade->new_grade)}} <br>
							@elseif(count($convert))

							
							{{strtoupper($convert->proposed_post)}} GL.{{strtoupper($convert->new_grade)}} <br>
                            @else
							--------------------- GL.----------- <br>
						...
						<table class="tbl" style="width: 100%">
							...
							<tr>
								...
								<td>@if(count($upgrade)){{$upgrade->post_considered}}
								@elseif(count($convert)){{$convert->proposed_post}}
								@endif
								</td>	
							</tr>
							<tr>
								<td><b>Additional Qualification</b></td>
								<td>@if(count($upgrade)){{$upgrade->additional_qualification}}
									@elseif(count($convert)){{$convert->proposed_post}}
								@endif</td>	
							</tr>
						</table>
