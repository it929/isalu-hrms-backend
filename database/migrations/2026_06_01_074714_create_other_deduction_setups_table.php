...
class CreateOtherDeductionSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_deduction_setups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('other_deduction_setups');
    }
}
